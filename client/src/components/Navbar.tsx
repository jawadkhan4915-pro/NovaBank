...
import { ShieldCheck, ShieldAlert, CreditCard, Landmark, ShoppingBag, Command, LogOut, User as UserIcon } from 'lucide-react';
...
export const Navbar: React.FC<NavbarProps> = ({ onOpenCmd, activeTab, setActiveTab }) => {
